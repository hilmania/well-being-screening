...
/* Custom navbar spacing - force consistent height and spacing */
.navbar.navbar-clone.fixed,
.navbar.navbar-clone.fixed.navbar-stuck {
    min-height: 55px !important;
    padding: 3px 0 !important;
}

.navbar.navbar-clone.fixed .container,
.navbar.navbar-clone.fixed.navbar-stuck .container {
    min-height: 35px !important;
    padding-top: 0.375rem !important;
    padding-bottom: 0.375rem !important;
}

.navbar.navbar-clone.fixed .navbar-nav,
.navbar.navbar-clone.fixed.navbar-stuck .navbar-nav {
    padding: 0.375rem 0 !important;
    min-height: 28px !important;
}

.navbar.navbar-clone.fixed .nav-item,
.navbar.navbar-clone.fixed.navbar-stuck .nav-item {
    margin: 0.375rem 0 !important;
}

.navbar.navbar-clone.fixed .btn,
.navbar.navbar-clone.fixed.navbar-stuck .btn {
  ...
  <div class="grow shrink-0">
    ...
    <section class="wrapper !bg-[#ffffff]">
      <div class="container pt-10 xl:pt-[4.5rem] lg:pt-[4.5rem] md:pt-[4.5rem] pb-[4.5rem] xl:pb-24 lg:pb-24 md:pb-24 !text-center">
        <div class="flex flex-wrap mx-[-15px] xl:mx-[-35px] lg:mx-[-20px] !mt-[-50px] xl:!mt-0 !mb-[4.5rem] items-center">
          <div class="xl:w-7/12 lg:w-7/12 w-full flex-[0_0_auto] !px-[15px] xl:!px-[35px] lg:!px-[20px] !mt-[50px] xl:!mt-0 max-w-full xl:!order-2 lg:!order-2">
            <figure class="m-0 p-0"><img class="img-auto" src="https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80" alt="Konsultasi Psikologi - Dukungan Mental Health"></figure>
          </div>
          <!-- /column -->
          <div class="md:w-10/12 md:!ml-[8.33333333%] lg:!ml-0 lg:w-5/12 xl:!ml-0 xl:w-5/12 w-full flex-[0_0_auto] !px-[15px] xl:!px-[35px] lg:!px-[20px] !mt-[50px] xl:!mt-0 max-w-full text-center lg:text-left xl:text-left">
            <h1 class="xl:!text-[2.7rem] !text-[calc(1.395rem_+_1.74vw)] !leading-[1.15] !mb-5 md:mx-[-1.25rem] lg:mx-0 !mt-7">Platform Kesehatan Mental <br class="xl:!hidden lg:!hidden md:!hidden">dan Screening <br class="xl:!hidden lg:!hidden md:!hidden"><span class="rotator-fade !text-[#5eb9f0]">KDRT,Konsultasi Psikologi,Dukungan Emosional</span></h1>
            <p class="lead !text-[1.1rem] !leading-[1.55] font-medium !mb-7">Kami menyediakan layanan screening KDRT yang aman dan konsultasi psikologi profesional untuk mendukung kesehatan mental Anda.</p>
            <span><a class="btn btn-lg btn-sky !text-white !bg-[#5eb9f0] border-[#5eb9f0] hover:text-white hover:!bg-[#5eb9f0] hover:!border-[#5eb9f0] focus:shadow-[rgba(88,167,216,1)] active:text-white active:!bg-[#5eb9f0] active:border-[#5eb9f0] disabled:text-white disabled:!bg-[#5eb9f0] disabled:border-[#5eb9f0]  !rounded-[50rem] !mr-2">Mulai Screening</a></span>
          </div>
          <!-- /column -->
        </div>
        <!-- /.row -->
        <p class="text-center !mb-8">Dipercaya oleh lebih dari 2K+ klien di seluruh Indonesia</p>
        <div class="flex flex-wrap mx-[-15px] row-cols-4 row-cols-md-4 row-cols-lg-7 row-cols-xl-7 !mt-[-50px] !mb-2 items-center justify-center">
          <div class="w-1/4 xl:w-[14.2857142857%] lg:w-[14.2857142857%] md:w-1/4 flex-[0_0_auto] !px-[15px] !mt-[50px] max-w-full">
            <img  class="md:!px-[0.75rem] lg:!px-0 xl:!px-[0.5rem] xxl:!px-[1.25rem]" src="./assets/img/brands/c1.png" alt="image">
          </div>
          <!--/column -->
          <div class="w-1/4 xl:w-[14.2857142857%] lg:w-[14.2857142857%] md:w-1/4 flex-[0_0_auto] !px-[15px] !mt-[50px] max-w-full">
            <img  class="md:!px-[0.75rem] lg:!px-0 xl:!px-[0.5rem] xxl:!px-[1.25rem]" src="./assets/img/brands/c2.png" alt="image">
          </div>
          <!--/column -->
          <div class="w-1/4 xl:w-[14.2857142857%] lg:w-[14.2857142857%] md:w-1/4 flex-[0_0_auto] !px-[15px] !mt-[50px] max-w-full">
            <img  class="md:!px-[0.75rem] lg:!px-0 xl:!px-[0.5rem] xxl:!px-[1.25rem]" src="./assets/img/brands/c3.png" alt="image">
          </div>
          <!--/column -->
          <div class="w-1/4 xl:w-[14.2857142857%] lg:w-[14.2857142857%] md:w-1/4 flex-[0_0_auto] !px-[15px] !mt-[50px] max-w-full">
            <img  class="md:!px-[0.75rem] lg:!px-0 xl:!px-[0.5rem] xxl:!px-[1.25rem]" src="./assets/img/brands/c4.png" alt="image">
          </div>
          <!--/column -->
          <div class="w-1/4 xl:w-[14.2857142857%] lg:w-[14.2857142857%] md:w-1/4 flex-[0_0_auto] !px-[15px] !mt-[50px] max-w-full">
            <img  class="md:!px-[0.75rem] lg:!px-0 xl:!px-[0.5rem] xxl:!px-[1.25rem]" src="./assets/img/brands/c5.png" alt="image">
          </div>
          <!--/column -->
          <div class="w-1/4 xl:w-[14.2857142857%] lg:w-[14.2857142857%] md:w-1/4 flex-[0_0_auto] !px-[15px] !mt-[50px] max-w-full">
            <img  class="md:!px-[0.75rem] lg:!px-0 xl:!px-[0.5rem] xxl:!px-[1.25rem]" src="./assets/img/brands/c6.png" alt="image">
          </div>
          <!--/column -->
          <div class="w-1/4 xl:w-[14.2857142857%] lg:w-[14.2857142857%] md:w-1/4 flex-[0_0_auto] !px-[15px] !mt-[50px] max-w-full">
            <img  class="md:!px-[0.75rem] lg:!px-0 xl:!px-[0.5rem] xxl:!px-[1.25rem]" src="./assets/img/brands/c7.png" alt="image">
          </div>
          <!--/column -->
        </div>
        <!-- /.row -->
    ...
    <!-- /section -->
    <header class="!relative wrapper !bg-[#ffffff]">
      <nav class="navbar navbar-expand-lg center-nav transparent navbar-light navbar-clone !fixed !min-h-[55px] !box-border" style="min-height: 55px !important; padding: 3px 0 !important;">
        <div class="container !flex-row !items-center !py-1 !min-h-[35px]" style="min-height: 35px !important; padding-top: 0.375rem !important; padding-bottom: 0.375rem !important;">
          <div class="navbar-brand !w-auto">
            <a href="./index.html">
              <img class="logo-dark" src="./assets/img/logo-dark.png" srcset="./assets/img/logo-dark@2x.png 2x" alt="image">
          ...
          <div class="navbar-collapse offcanvas offcanvas-nav offcanvas-start">
            ...
            <div class="offcanvas-body xl:!ml-auto lg:!ml-auto flex  flex-col !h-full">
              <ul class="navbar-nav !py-1 !min-h-[28px]" style="padding: 0.375rem 0 !important; min-height: 28px !important;">
                <li class="nav-item !my-1" style="margin: 0.375rem 0 !important;">
                  <a class="btn btn-sm btn-sky !text-white !bg-[#5eb9f0] border-[#5eb9f0] hover:text-white hover:!bg-[#5eb9f0] hover:!border-[#5eb9f0] focus:shadow-[rgba(88,167,216,1)] active:text-white active:!bg-[#5eb9f0] active:border-[#5eb9f0] disabled:text-white disabled:!bg-[#5eb9f0] disabled:border-[#5eb9f0] !rounded-[50rem] btn-icon btn-icon-start mr-4 !px-4 !py-1" href="./contact.html" style="padding: 0.2rem 1rem !important; margin: 0.2rem 0 !important; min-height: 28px !important;">
                    <i class="uil uil-phone-volume before:content-['\ec50']"></i> Contact
                  </a>
                </li>
              </ul>
              <!-- /.navbar-nav -->
              <div class="offcanvas-footer xl:hidden lg:hidden">
                <div>
                  ...
                  <br> 00 (123) 456 78 90 <br>
                  <nav class="nav social social-white !mt-4">
                    <a class="text-[#cacaca] text-[1rem] transition-all duration-[0.2s] ease-in-out translate-y-0 motion-reduce:transition-none hover:translate-y-[-0.15rem] m-0 p-0" href="#"><i class="uil uil-twitter before:content-['\ed59'] text-[1rem] text-[#cacaca]"></i></a>
                    <a class="text-[#cacaca] text-[1rem] transition-all duration-[0.2s] ease-in-out translate-y-0 motion-reduce:transition-none hover:translate-y-[-0.15rem] m-0 p-0" href="#"><i class="uil uil-facebook-f before:content-['\eae2'] text-[1rem] text-[#cacaca]"></i></a>
                    <a class="text-[#cacaca] text-[1rem] transition-all duration-[0.2s] ease-in-out translate-y-0 motion-reduce:transition-none hover:translate-y-[-0.15rem] m-0 p-0" href="#"><i class="uil uil-dribbble before:content-['\eaa2'] text-[1rem] text-[#cacaca]"></i></a>
                    <a class="text-[#cacaca] text-[1rem] transition-all duration-[0.2s] ease-in-out translate-y-0 motion-reduce:transition-none hover:translate-y-[-0.15rem] m-0 p-0" href="#"><i class="uil uil-instagram before:content-['\eb9c'] text-[1rem] text-[#cacaca]"></i></a>
                    <a class="text-[#cacaca] text-[1rem] transition-all duration-[0.2s] ease-in-out translate-y-0 motion-reduce:transition-none hover:translate-y-[-0.15rem] m-0 p-0" href="#"><i class="uil uil-youtube before:content-['\edb5'] text-[1rem] text-[#cacaca]"></i></a>
                  </nav>
                  <!-- /.social -->
                </div>
              </div>
          ...
          <!-- /.navbar-collapse -->
          <div class="navbar-other w-full !flex !ml-auto !py-1 !min-h-[28px]" style="padding: 0.375rem 0 !important; min-height: 28px !important;">
            <ul class="navbar-nav !flex-row !items-center !ml-auto" data-sm-skip="true">
              <li class="nav-item"><a class="nav-link" data-toggle="offcanvas-info">
                  <i class="uil uil-info-circle before:content-['\eb99']"></i>
                </a></li>
              <li class="nav-item xl:hidden lg:hidden">
                <button class="hamburger offcanvas-nav-btn"><span></span></button>
              </li>
      ...
      <div class="container pt-14 xl:pt-8 lg:pt-8 pb-[4.5rem] xl:pb-28 lg:pb-28 md:pb-28">
        <div class="flex flex-wrap mx-[-15px] !text-center">
          <div class="md:w-10/12 xl:w-8/12 lg:w-8/12 w-full flex-[0_0_auto] !px-[15px] max-w-full xl:!ml-[16.66666667%] lg:!ml-[16.66666667%] md:!ml-[8.33333333%]">
            <h2 class="!text-[0.8rem] uppercase !text-[#5eb9f0] !mb-3 !leading-[1.35] !tracking-[0.02rem]">Layanan Kami</h2>
            <h3 class="xl:!text-[2.1rem] !text-[calc(1.335rem_+_1.02vw)] !leading-[1.2] !mb-10 xxl:!px-10">Layanan yang kami tawarkan dirancang khusus untuk mendukung kesehatan mental Anda.</h3>
          </div>
          <!-- /column -->
        </div>
        <!-- /.row -->
        <div class="flex flex-wrap mx-[-15px] xl:mx-[-35px] lg:mx-[-20px] !mt-[-60px] xxl:!px-5 !text-center items-end">
          ...
          <div class="xl:w-4/12 lg:w-4/12 w-full flex-[0_0_auto] xl:!px-[35px] lg:!px-[20px] !px-[15px] max-w-full !mt-[60px]">
            <div class="md:!px-20 lg:!px-3 xl:!px-3">
              <figure class="!mb-6"><img class="max-w-full h-auto" src="https://images.unsplash.com/photo-1559757148-5c350d0d3c56?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&q=80" alt="Konsultasi Psikologi"></figure>
              <h3>Konsultasi Psikologi</h3>
              <p class="!mb-2">Layanan konsultasi dengan psikolog profesional untuk membantu mengatasi masalah emosional dan mental dengan pendekatan yang personal.</p>
              <a href="#" class="more hover">Pelajari Lebih Lanjut</a>
            </div>
            <!--/.px -->
          </div>
          ...
          <div class="xl:w-4/12 lg:w-4/12 w-full flex-[0_0_auto] xl:!px-[35px] lg:!px-[20px] !px-[15px] max-w-full !mt-[60px]">
            <div class="md:!px-20 lg:!px-3 xl:!px-3">
              <figure class="!mb-6"><img class="max-w-full h-auto" src="https://images.unsplash.com/photo-1544027993-37dbfe43562a?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&q=80" alt="Dukungan Emosional"></figure>
              <h3>Dukungan Emosional</h3>
              <p class="!mb-2">Program dukungan emosional berkelanjutan untuk membantu Anda dalam perjalanan penyembuhan dan pemulihan mental yang holistik.</p>
              <a href="#" class="more hover">Pelajari Lebih Lanjut</a>
            </div>
            <!--/.px -->
          </div>
    ...
    <section class="wrapper !bg-[#ffffff]">
      <div class="container pb-[4.5rem] xl:pb-28 lg:pb-28 md:pb-28">
        <div class="flex flex-wrap mx-[-15px] md:mx-[-20px] lg:mx-[-20px] xl:mx-[-35px] !mt-[-50px] items-center">
          <div class="xl:w-6/12 lg:w-6/12 w-full flex-[0_0_auto] !px-[15px] md:!px-[20px] lg:!px-[20px] xl:!px-[35px] !mt-[50px] max-w-full xl:!order-2 lg:!order-2">
            <div class="card !shadow-[0_0.25rem_1.75rem_rgba(30,34,40,0.07)] lg:!mr-6 xl:!mr-6">
              <div class="card-body p-6">
                <div class="flex flex-row">
                  <div>
                    <span class="icon btn btn-circle btn-lg btn-soft-sky pointer-events-none !mr-4 xl:!text-[1.3rem] !w-12 !h-12 !text-[calc(1.255rem_+_0.06vw)] inline-flex items-center justify-center leading-none !p-0 !rounded-[100%]"><span class="number table-cell text-center align-middle text-[1.1rem] font-bold m-[0_auto]">01</span></span>
                  </div>
                  <div>
            ...
            <div class="card !shadow-[0_0.25rem_1.75rem_rgba(30,34,40,0.07)] lg:!ml-16 xl:!ml-16 !mt-6">
              <div class="card-body p-6">
                <div class="flex flex-row">
                  <div>
                    <span class="icon btn btn-circle btn-lg btn-soft-sky pointer-events-none !mr-4 xl:!text-[1.3rem] !w-12 !h-12 !text-[calc(1.255rem_+_0.06vw)] inline-flex items-center justify-center leading-none !p-0 !rounded-[100%]"><span class="number table-cell text-center align-middle text-[1.1rem] font-bold m-[0_auto]">02</span></span>
                  </div>
                  <div>
            ...
            <div class="card !shadow-[0_0.25rem_1.75rem_rgba(30,34,40,0.07)] lg:mx-6 xl:mx-6 !mt-6">
              <div class="card-body p-6">
                <div class="flex flex-row">
                  <div>
                    <span class="icon btn btn-circle btn-lg btn-soft-sky pointer-events-none !mr-4 xl:!text-[1.3rem] !w-12 !h-12 !text-[calc(1.255rem_+_0.06vw)] inline-flex items-center justify-center leading-none !p-0 !rounded-[100%]"><span class="number table-cell text-center align-middle text-[1.1rem] font-bold m-[0_auto]">03</span></span>
                  </div>
                  <div>
          ...
          <div class="xl:w-6/12 lg:w-6/12 w-full flex-[0_0_auto] !px-[15px] md:!px-[20px] lg:!px-[20px] xl:!px-[35px] !mt-[50px] max-w-full">
            <h2 class="!text-[0.8rem] uppercase !text-[#5eb9f0] !mb-3 !leading-[1.35] !tracking-[0.02rem]">Our Strategy</h2>
            <h3 class="xl:!text-[2.1rem] !text-[calc(1.335rem_+_1.02vw)] !leading-[1.2] !mb-4">Here are 3 working steps to organize our projects.</h3>
      ...
      <div class="container !pb-[4.5rem] xl:!pb-24 lg:!pb-24 md:!pb-24">
        <div class="flex flex-wrap mx-[-15px] xl:mx-[-35px] lg:mx-[-20px] !mt-[-50px] items-center">
          <div class="xl:w-7/12 lg:w-7/12 w-full flex-[0_0_auto] xl:!px-[35px] lg:!px-[20px] !px-[15px] !mt-[50px] max-w-full">
            <figure class="m-0 p-0"><img class="img-auto" src="./assets/img/illustrations/i22.png" srcset="./assets/img/illustrations/i22@2x.png 2x" alt="image"></figure>
          </div>
          <!--/column -->
          <div class="xl:w-5/12 lg:w-5/12 w-full flex-[0_0_auto] xl:!px-[35px] lg:!px-[20px] !px-[15px] !mt-[50px] max-w-full">
            <h2 class="!text-[.75rem] uppercase !text-[#5eb9f0] !tracking-[0.02rem] !leading-[1.35] !mb-3">Why Choose Us?</h2>
            <h3 class="xl:!text-[2.1rem] !text-[calc(1.335rem_+_1.02vw)] !leading-[1.2] !mb-7">We bring solutions to make life easier.</h3>
            <div class="accordion accordion-wrapper" id="accordionExample">
              <div class="card plain accordion-item">
                <div class="card-header !mb-0 !p-[0_0_.8rem_0] !border-0 !bg-inherit" id="headingOne">
                  <button class="accordion-button !text-[0.9rem] hover:!text-[#5eb9f0] before:!text-[#5eb9f0]" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne"> Professional Design </button>
                </div>
                <!--/.card-header -->
              ...
              <div class="card plain accordion-item">
                <div class="card-header !mb-0 !p-[0_0_.8rem_0] !border-0 !bg-inherit" id="headingTwo">
                  <button class="collapsed !text-[0.9rem] hover:!text-[#5eb9f0] before:!text-[#5eb9f0]" data-bs-toggle="collapse" data-bs-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo"> Top-Notch Support </button>
                </div>
                <!--/.card-header -->
              ...
              <div class="card plain accordion-item">
                <div class="card-header !mb-0 !p-[0_0_.8rem_0] !border-0 !bg-inherit" id="headingThree">
                  <button class="collapsed !text-[0.9rem] hover:!text-[#5eb9f0] before:!text-[#5eb9f0]" data-bs-toggle="collapse" data-bs-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree"> Header and Slider Options </button>
                </div>
                <!--/.card-header -->
    ...
    <section class="wrapper !bg-[#ffffff]">
      ...
      <!-- /.container -->
      <div class="overflow-hidden">
        <div class="container pt-14 xl:pt-7 lg:pt-7 pb-[4.5rem] xl:pb-24 lg:pb-24 md:pb-24">
          <div class="flex flex-wrap mx-[-15px]">
            <div class="lg:w-10/12 xl:w-9/12 xxl:w-8/12 w-full flex-[0_0_auto] !px-[15px] max-w-full !mx-auto !text-center">
              <h2 class="!text-[0.8rem] uppercase !text-[#5eb9f0] !mb-3 !leading-[1.35] !tracking-[0.02rem]">Latest Projects</h2>
             <h3 class="xl:!text-[2.1rem] !text-[calc(1.335rem_+_1.02vw)] !leading-[1.2] !mb-10">Check out some of our awesome projects with creative ideas and great design.</h3>
            </div>
            <!-- /column -->
          </div>
          <!-- /.row -->
          <div class="swiper-container grid-view nav-bottom nav-color !mb-[4.5rem] relative z-10" data-margin="30" data-dots="false" data-nav="true" data-items-md="2" data-items-xs="1">
            <div class="swiper overflow-visible">
              <div class="swiper-wrapper">
                <div class="swiper-slide">
                  ...
                  <div class="project-details flex justify-center flex-col">
                    <div class="post-header">
                      <h2 class="post-title h3"><a href="./single-project.html" class="!text-[#343f52] hover:!text-[#5eb9f0]">Cras Fermentum Sem</a></h2>
                ...
                <div class="swiper-slide">
                  ...
                  <div class="project-details flex justify-center flex-col">
                    <div class="post-header">
                      <h2 class="post-title h3"><a href="./single-project.html" class="!text-[#343f52] hover:!text-[#5eb9f0]">Venenatis Euismod Vehicula</a></h2>
                ...
                <div class="swiper-slide">
                  ...
                  <div class="project-details flex justify-center flex-col">
                    <div class="post-header">
                      <h2 class="post-title h3"><a href="./single-project.html" class="!text-[#343f52] hover:!text-[#5eb9f0]">Tortor Tellus Cursus</a></h2>
                ...
                <div class="swiper-slide">
                  ...
                  <div class="project-details flex justify-center flex-col">
                    <div class="post-header">
                      <h2 class="post-title h3"><a href="./single-project.html" class="!text-[#343f52] hover:!text-[#5eb9f0]">Ridiculus Sem Parturient</a></h2>
                ...
                <div class="swiper-slide">
                  ...
                  <div class="project-details flex justify-center flex-col">
                    <div class="post-header">
                      <h2 class="post-title h3"><a href="./single-project.html" class="!text-[#343f52] hover:!text-[#5eb9f0]">Cursus Sollicitudin Adipiscing</a></h2>
                      <div class="uppercase !tracking-[0.02rem] text-[0.7rem] font-bold !mb-[0.4rem] !text-[#9499a3]">Web Design</div>
                    </div>
                    <!-- /.post-header -->
                  </div>
                ...
                <div class="swiper-slide">
                  ...
                  <div class="project-details flex justify-center flex-col">
                    <div class="post-header">
                      <h2 class="post-title h3"><a href="./single-project.html" class="!text-[#343f52] hover:!text-[#5eb9f0]">Fringilla Quam Vulputate</a></h2>
                      <div class="uppercase !tracking-[0.02rem] text-[0.7rem] font-bold !mb-[0.4rem] !text-[#9499a3]">Stationary</div>
                    </div>
                    <!-- /.post-header -->
                  </div>
      ...
      <div class="container pt-14 xl:pt-8 lg:pt-8 pb-[4.5rem] xl:pb-28 lg:pb-28 md:pb-28">
        <div class="flex flex-wrap mx-[-15px] !text-center">
          <div class="lg:w-8/12 xl:w-8/12 w-full flex-[0_0_auto] !px-[15px] max-w-full xl:!ml-[16.66666667%] lg:!ml-[16.66666667%]">
            <h2 class="!text-[0.8rem] uppercase !text-[#5eb9f0] !mb-3 !leading-[1.35] !tracking-[0.02rem]">Testimoni Klien</h2>
    ...
    <section class="wrapper !bg-[#ffffff]">
      <div class="container pt-6 pb-[4.5rem] xl:pb-24 lg:pb-24 md:pb-24">
        <div class="flex flex-wrap mx-[-15px] xl:mx-[-35px] lg:mx-[-20px] !mt-[-50px]">
          <div class="xl:w-6/12 lg:w-6/12 w-full flex-[0_0_auto] !px-[15px] max-w-full !mb-0 xl:!px-[35px] lg:!px-[20px] !mt-[50px]">
            <h2 class="!text-[0.8rem] uppercase !text-[#5eb9f0] !leading-[1.35] !tracking-[0.02rem]  !mb-4">FAQ</h2>
            <h3 class="xl:!text-[2.1rem] !text-[calc(1.335rem_+_1.02vw)] !leading-[1.2] !mb-4">If you don't see an answer to your question, you can send us an email from our contact form.</h3>
            ...
            <div id="accordion-3" class="accordion-wrapper">
              <div class="card accordion-item !mb-5 !shadow-[0_0.25rem_1.75rem_rgba(30,34,40,0.07)]">
                <div class="card-header !mb-0 !p-[.9rem_1.3rem_.85rem] !border-0 !bg-inherit" id="accordion-heading-3-1">
                  <button class="hover:!text-[#5eb9f0] before:!text-[#5eb9f0] collapsed" data-bs-toggle="collapse" data-bs-target="#accordion-collapse-3-1" aria-expanded="false" aria-controls="accordion-collapse-3-1">How do I get my subscription receipt?</button>
                </div>
                <!-- /.card-header -->
              ...
              <div class="card accordion-item !mb-5 !shadow-[0_0.25rem_1.75rem_rgba(30,34,40,0.07)]">
                <div class="card-header !mb-0 !p-[.9rem_1.3rem_.85rem] !border-0 !bg-inherit" id="accordion-heading-3-2">
                  <button class="hover:!text-[#5eb9f0] before:!text-[#5eb9f0] collapsed" data-bs-toggle="collapse" data-bs-target="#accordion-collapse-3-2" aria-expanded="false" aria-controls="accordion-collapse-3-2">Are there any discounts for people in need?</button>
                </div>
                <!-- /.card-header -->
              ...
              <div class="card accordion-item !mb-5 !shadow-[0_0.25rem_1.75rem_rgba(30,34,40,0.07)]">
                <div class="card-header !mb-0 !p-[.9rem_1.3rem_.85rem] !border-0 !bg-inherit" id="accordion-heading-3-3">
                  <button class="hover:!text-[#5eb9f0] before:!text-[#5eb9f0] collapsed" data-bs-toggle="collapse" data-bs-target="#accordion-collapse-3-3" aria-expanded="false" aria-controls="accordion-collapse-3-3">Do you offer a free trial edit?</button>
                </div>
                <!-- /.card-header -->
              ...
              <div class="card accordion-item !mb-5 !shadow-[0_0.25rem_1.75rem_rgba(30,34,40,0.07)]">
                <div class="card-header !mb-0 !p-[.9rem_1.3rem_.85rem] !border-0 !bg-inherit" id="accordion-heading-3-4">
                  <button class="hover:!text-[#5eb9f0] before:!text-[#5eb9f0] collapsed" data-bs-toggle="collapse" data-bs-target="#accordion-collapse-3-4" aria-expanded="false" aria-controls="accordion-collapse-3-4">How do I reset my Account password?</button>
                </div>
                <!-- /.card-header -->
  ...
  <footer class="bg-[rgba(52,63,82)] opacity-100 !text-[#cacaca]">
    <div class="container pt-14 xl:pt-6 lg:pt-6 pb-16 xl:pb-20 lg:pb-20 md:pb-20">
      <div class="xl:!flex lg:!flex flex-row xl:!items-center lg:!items-center">
        <h3 class="xl:!text-[2.1rem] !text-[calc(1.335rem_+_1.02vw)] !leading-[1.2] !mb-6 lg:!mb-0 xl:!mb-0 xl:!pr-40 lg:!pr-40 xxl:!pr-[22.5rem] !text-white">Bergabunglah dengan komunitas kami untuk mendapatkan dukungan kesehatan mental yang berkelanjutan.</h3>
        <a href="#" class="btn btn-sky !text-white !bg-[#5eb9f0] border-[#5eb9f0] hover:text-white hover:!bg-[#5eb9f0] hover:!border-[#5eb9f0] focus:shadow-[rgba(88,167,216,1)] active:text-white active:!bg-[#5eb9f0] active:border-[#5eb9f0] disabled:text-white disabled:!bg-[#5eb9f0] disabled:border-[#5eb9f0] !rounded-[50rem]  !mb-0 whitespace-nowrap">Mulai Konsultasi</a>
      </div>
      <!--/div -->
      ...
      <div class="flex flex-wrap mx-[-15px] !mt-[-30px] xl:!mt-0 lg:!mt-0">
        ...
        <div class="md:w-4/12 xl:w-3/12 lg:w-3/12 w-full flex-[0_0_auto] !px-[15px] max-w-full xl:!mt-0 lg:!mt-0 !mt-[30px]">
          <div class="widget !text-[#cacaca]">
            ...
            <a class="!text-[#cacaca] hover:!text-[#5eb9f0]" href="mailto:first.last@email.com">info@email.com</a><br> 00 (123) 456 78 90
          </div>
          <!-- /.widget -->
        </div>
        <!-- /column -->
        <div class="md:w-4/12 xl:w-3/12 lg:w-3/12 w-full flex-[0_0_auto] !px-[15px] max-w-full xl:!mt-0 lg:!mt-0 !mt-[30px]">
          <div class="widget !text-[#cacaca]">
            ...
            <ul class="pl-0 list-none   !mb-0">
              <li><a class="!text-[#cacaca] hover:!text-[#5eb9f0]" href="#">About Us</a></li>
              <li class="!mt-[0.35rem]"><a class="!text-[#cacaca] hover:!text-[#5eb9f0]" href="#">Our Story</a></li>
              <li class="!mt-[0.35rem]"><a class="!text-[#cacaca] hover:!text-[#5eb9f0]" href="#">Projects</a></li>
              <li class="!mt-[0.35rem]"><a class="!text-[#cacaca] hover:!text-[#5eb9f0]" href="#">Terms of Use</a></li>
              <li class="!mt-[0.35rem]"><a class="!text-[#cacaca] hover:!text-[#5eb9f0]" href="#">Privacy Policy</a></li>
            </ul>
          </div>
          <!-- /.widget -->
        </div>
